...
class ApplyJobView(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        form = self.get_form()
        if form.is_valid():
            messages.info(self.request, 'ALERT: You have successfully applied. Did you upload your resume by editing your profile? Hover over your name in the menu bar to edit.')
