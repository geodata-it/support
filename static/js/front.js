    ...
    if ($('#map').length > 0) {
        ...
        function initMap() {
            ...
            var contentString = '<div class="info-window">' +
                ...
                '<p>Pellentesque habitant morbi tristique senectus et netus et Top_Secretsuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>' +
                '</div>' +
                '</div>';
